...
<section
	...
	foreach ( $child_pages as $child_page ) {
		...
		if ( in_array( $category_slug, $hibernated_slugs, true ) ) {
			continue;
		}
	...
	echo implode( '', array_column( $cards, 'html' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	?>
	<div class="text-center pt-4 <?= count( $cards ) <= 5 ? 'w-100' : ''; ?>">
